...
ADD (
  ...
  CONSTRAINT fk_notas_comp FOREIGN KEY (Id_Comp)
    REFERENCES Componente_Nota (Id_Comp),
...
CREATE OR REPLACE TRIGGER trg_auditoria_nota_final
AFTER UPDATE OF Valor_Novo ON Log_Nota_Final
FOR EACH ROW
BEGIN
  INSERT INTO Log_Nota_Final (
    DataHora,
    Acao,
    Valor_Antigo,
    Valor_Novo,
