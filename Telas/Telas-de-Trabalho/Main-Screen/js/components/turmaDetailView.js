import { createSnapshot, calculateFinalGrade, adjustGrade, testAndValidateFormula } from '../utils/helpers.js';
import { addAuditLog, renderAuditLog, setCurrentTurmaContext } from './auditLog.js';

export function renderTurmaDetailView(turma, disciplina, views, MOCK_DATA, addStudentModal, finalizeSemesterModal, reopenTurmaModal, renderInstitutions, renderInstitutionsFlyout, renderDashboardView, renderActiveTurmasView, alert) {
    setCurrentTurmaContext({ turma, disciplina });
    ...
    if (!isFinalized) {
        ...
        document.getElementById('add-component-btn').addEventListener('click', () => {
            ...
            if (nameInput.value && acronymInput.value) {
                ...
                renderTurmaDetailView(turma, disciplina, views, MOCK_DATA, addStudentModal, finalizeSemesterModal, reopenTurmaModal, renderInstitutions, renderInstitutionsFlyout, renderDashboardView, renderActiveTurmasView, alert);
            }
        });
